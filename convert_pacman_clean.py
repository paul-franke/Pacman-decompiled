...
# 8. Convert &pointer[index] where pointer is a pointer type to (pointer + index)
# e.g., &P1_SCORE[2] -> (P1_SCORE + 2), &P1_PILL_ARRAY[0] -> (P1_PILL_ARRAY + 0)
...
print('Pacman.cs regenerated cleanly!')
